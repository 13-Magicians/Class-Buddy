...
class ACYPreO extends StatefulWidget {
  final Function(int) onCardPressed;
  const ACYPreO({Key? key, required this.onCardPressed}) : super(key: key);

  @override
  State<ACYPreO> createState() => _ACYPreOState();
}

class _ACYPreOState extends State<ACYPreO> with WidgetsBindingObserver {
