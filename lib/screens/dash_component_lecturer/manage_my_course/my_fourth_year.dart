...
class ACYFourth extends StatefulWidget {
  final Function(int) onCardPressed;
  const ACYFourth({Key? key, required this.onCardPressed}) : super(key: key);

  @override
  State<ACYFourth> createState() => _ACYFourthState();
}

class _ACYFourthState extends State<ACYFourth> with WidgetsBindingObserver {
