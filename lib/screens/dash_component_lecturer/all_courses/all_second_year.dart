...
class AACYSecond extends StatefulWidget {
  final Function(int) onACCardPressed;
  const AACYSecond({Key? key, required this.onACCardPressed}) : super(key: key);

  @override
  State<AACYSecond> createState() => _AACYSecondState();
}

class _AACYSecondState extends State<AACYSecond> with WidgetsBindingObserver {
        ...
        child: Column(
          children: [
            Card(
              ...
              child: ListTile(
                title: const Text('Second Year First Semester'),
                        ...
                        children: [
                          ...
                          FutureBuilder<List<Map<String, dynamic>>>(
                            future: AcademicOperation()
                                .getMyCourse(item['documentID'],'21'),
                            builder: (context,
            ...
            Column(
              children: [
                Card(
                  margin: const EdgeInsets.all(0),
                  child: ListTile(
                    title: const Text('Second Year Second Semester'),
                    tileColor: Colors.teal,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                  ),
                ),
                        ...
                        body: SizedBox(
                          child: Column(
                            children: [
                              ...
                              FutureBuilder<List<Map<String, dynamic>>>(
                                future: AcademicOperation()
                                    .getMyCourse(item['documentID'],'22'),
                                builder: (context,
                                    AsyncSnapshot<List<Map<String, dynamic>>>
                                    snapshot) {
                                  if (snapshot.connectionState ==
