...
class AACYThird extends StatefulWidget {
  final Function(int) onACCardPressed;
  const AACYThird({Key? key, required this.onACCardPressed}) : super(key: key);

  @override
  State<AACYThird> createState() => _AACYThirdState();
}

class _AACYThirdState extends State<AACYThird> with WidgetsBindingObserver {
