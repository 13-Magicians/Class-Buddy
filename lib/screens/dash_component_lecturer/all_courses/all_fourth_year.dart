...
class AACYFourth extends StatefulWidget {
  final Function(int) onACCardPressed;
  const AACYFourth({Key? key, required this.onACCardPressed}) : super(key: key);

  @override
  State<AACYFourth> createState() => _AACYFourthState();
}

class _AACYFourthState extends State<AACYFourth> with WidgetsBindingObserver {
  ...
  loadData() async {
    ...
    acYearList.removeWhere((item) => item['currentYear'] < 4);
    setState(() {});
  }
        ...
        child: Column(
          children: [
            Card(
              ...
              child: ListTile(
                title: const Text('Fourth Year First Semester'),
                        ...
                        children: [
                          ...
                          FutureBuilder<List<Map<String, dynamic>>>(
                            future: AcademicOperation()
                                .getMyCourse(item['documentID'],'41'),
                            builder: (context,
            ...
            Column(
              children: [
                Card(
                  margin: const EdgeInsets.all(0),
                  child: ListTile(
                    title: const Text('Fourth Year Second Semester'),
                    tileColor: Colors.teal,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                  ),
                ),
                        ...
                        body: SizedBox(
                          child: Column(
                            children: [
                              ...
                              FutureBuilder<List<Map<String, dynamic>>>(
                                future: AcademicOperation()
                                    .getMyCourse(item['documentID'],'42'),
                                builder: (context,
                                    AsyncSnapshot<List<Map<String, dynamic>>>
                                    snapshot) {
                                  if (snapshot.connectionState ==
