...
class DisplayAllCourseThirdYear extends StatefulWidget {
  const DisplayAllCourseThirdYear({super.key});

  @override
  State<DisplayAllCourseThirdYear> createState() => _DisplayAllCourseThirdYearState();
}

class _DisplayAllCourseThirdYearState extends State<DisplayAllCourseThirdYear> {
  @override
          ...
          children: [
            ...
            Flexible(
              ...
              child: FutureBuilder<List<Map<String, dynamic>>>(
                future: StudentOperations().getAllCourses('31'),
            ...
            Flexible(
              flex: 1,
              child: FutureBuilder<List<Map<String, dynamic>>>(
                future: StudentOperations().getAllCourses('32'),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return Center(child: CircularProgressIndicator());
                  } else if (snapshot.hasError) {
